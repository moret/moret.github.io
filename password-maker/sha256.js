...
function hex_sha256(){var s=makeHashKeyByConcatenation();return binb2hex(core_sha256(str2binb(s),s.length * chrsz));}
function b64_sha256(){var s=makeHashKeyByConcatenation();return binb2b64(core_sha256(str2binb(s),s.length * chrsz));}
function str_sha256(){var s=makeHashKeyByConcatenation();return binb2str(core_sha256(str2binb(s),s.length * chrsz));}
